# Curated README gallery (not a dump)

| File | Shot |
|------|------|
| `01-hero.png` | Hero / brand |
| `02-home-v2.jpg` | Home dark UI v2 |
| `03-overlay-keep-keyboard.jpg` | Overlay + keep keyboard |
| `04-hinglish.jpg` | Speech = Hinglish |
...
`/workspace/whispertype-launch/artifacts/from-kunal/demos-v2/demo-02.mp4`
